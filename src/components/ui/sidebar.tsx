...
>(({ className, ...props }, ref) => {
  return (
    <SheetContent
      ...
      side="left"
      className={cn(
        "flex w-[min(var(--sidebar-width-mobile),calc(100vw-1rem))] flex-col bg-sidebar p-0 text-sidebar-foreground",
        className
      )}
      style={
        {
...
>(({ className, ...props }, ref) => {
  return (
    <Separator
      ...
      className={cn("mx-0 h-[1px] w-full bg-sidebar-border/50", className)}
      {...props}
    />
  )
})
