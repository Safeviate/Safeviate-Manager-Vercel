...
import { Navigation, Trash2, Edit, Save, PlusCircle, Map as MapIcon } from 'lucide-react';
...
/**
 * NavlogBuilder - High-Density Data Table
 * Displays the route generated by the Interactive Planner.
 */
            ...
            <div className="overflow-x-auto">
                <Table>
                    <TableHeader className="bg-muted/30">
                        <TableRow>
                            <TableHead className="w-12 text-[10px] uppercase font-black">Leg</TableHead>
                            ...
                            <TableHead className="text-right text-[10px] uppercase font-black">Fuel</TableHead>
                            <TableHead className="text-right text-[10px] uppercase font-black no-print">Actions</TableHead>
                        </TableRow>
                    </TableHeader>
                    <TableBody>
                        {legs.map((leg, index) => (
                            <TableRow key={leg.id} className="hover:bg-muted/5 transition-colors">
                                <TableCell className="font-black text-xs text-muted-foreground">{index + 1}</TableCell>
                                <TableCell>
                                ...
                                <TableCell className="text-right font-mono text-sm">{leg.tripFuel?.toFixed(1)}</TableCell>
