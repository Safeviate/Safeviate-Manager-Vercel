...
// Self-contained data fetching hook for this new component
...
export function GeminiLogbook({ userProfile }: GeminiLogbookProps) {
    ...
    if (isLoading) {
        return (
            <Card>
                <CardHeader>
                    <CardTitle>My Simple Logbook</CardTitle>
                    <CardDescription>A basic record of your completed flights.</CardDescription>
                </CardHeader>
                <CardContent>
                ...
                <Table>
                    <TableHeader>
                        <TableRow>
                            ...
                            <TableHead>Pilot in Command</TableHead>
                            ...
                            userBookings.map(booking => {
                                ...
                                return (
                                    <TableRow key={booking.id}>
                                        ...
                                        <TableCell>{flightHours}h</TableCell>
                                    </TableRow>
                                );
                            })
                        ) : (
