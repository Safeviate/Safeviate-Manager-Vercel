              ...
              <div className="space-y-10">
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    ...
                    {teamFields.length === 0 && <p className="text-sm text-muted-foreground italic text-center py-4">No team members assigned.</p>}
                  </div>
                </div>
                ...
                <div>
                    ...
                    <div className='space-y-4'>
                        ...
                        {hazardFields.length === 0 && <p className="text-sm text-muted-foreground italic text-center py-4">No initial hazards identified.</p>}
                    </div>
                </div>
                  ...
                  <div className="space-y-4">
                    {taskFields.map((field, index) => (
                        <div key={field.id} className="grid grid-cols-1 md:grid-cols-4 items-end gap-4 p-4 border rounded-lg bg-muted/10">
                            ...
                            <Button type="button" variant="destructive" size="icon" onClick={() => removeTask(index)} className="no-print"><Trash2 className="h-4 w-4" /></Button>
                        </div>
                    ))}
                    {taskFields.length === 0 && <p className="text-sm text-muted-foreground italic text-center py-4">No investigation tasks defined.</p>}
                  </div>
                </div>
