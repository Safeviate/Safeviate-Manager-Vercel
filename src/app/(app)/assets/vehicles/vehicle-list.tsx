...
import { ArrowRight, Car, Eye, GaugeCircle, Trash2 } from 'lucide-react';
            ...
            <Card key={vehicle.id} className="shadow-sm border-slate-200">
              ...
              <CardFooter className="p-2 border-t bg-muted/5">
                <div className="flex w-full gap-2">
                  <Button asChild variant="ghost" size="sm" className="flex-1 justify-between text-xs font-bold h-8">
