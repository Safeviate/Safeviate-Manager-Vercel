  ...
  const expirySettingsRef = useMemoFirebase(
    () =>
      firestore?.type === 'firestore'
        ? doc(firestore, `tenants/${tenantId}/settings/document-expiry`)
        : null,
    [firestore, tenantId]
  );
    ...
    <>
      <Card>
        <CardHeader>
          ...
          <CardDescription>Manage airworthiness certificates, insurance, and other essential documents.</CardDescription>
        </CardHeader>
        <CardContent>
