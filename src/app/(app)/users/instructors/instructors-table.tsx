          ...
          <Card key={pilot.id} className="overflow-hidden border shadow-none transition-shadow hover:shadow-sm">
            ...
            <CardContent className="space-y-4 px-4 py-4">
              ...
              <div className="flex justify-end gap-2">
                ...
                <Button asChild variant="ghost" size="sm" className="h-8 px-3 text-xs font-bold" disabled>
                  <Link href={`/users/personnel/${pilot.id}?type=${pilot.userType}`} className="pointer-events-none opacity-50">
                    View Profile
                  </Link>
                </Button>
              </div>
