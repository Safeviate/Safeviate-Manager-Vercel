      ...
      >
        <colgroup>
         ...
         <thead>
          <tr>
            {colWidths.map((_, i) => (
              <th key={`header-${i}`} className="relative border border-muted bg-muted h-8 p-0">
                <div
                  onMouseDown={(e) => onResizeMouseDown(e, i)}
                  className="absolute top-0 right-0 h-full w-2 cursor-col-resize z-20 hover:bg-primary/50"
                />
              </th>
            ))}
          </tr>
