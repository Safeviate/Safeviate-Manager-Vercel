...
Cohesion: 0.09
Nodes (37): defaultSettings, OverdueMonitorSettings, Role, ChecklistTemplateCard(), ASSET_CATEGORY_LABELS, INDUSTRY_TYPES, TenantConfigPayload, TenantFormProps (+29 more)
...
Cohesion: 0.04
Nodes (70): DepartmentPage(), ExternalCompaniesPage(), MassBalanceConfigPage(), OverdueSettingsPage(), AdminPage(), PageFormatPage(), VisibilityManager(), RolesPage() (+62 more)
...
Cohesion: 0.14
Nodes (28): DEFAULT_TOPICS, ExamTopicsSettings, RoleActionsProps, parseLocalDate(), VehicleList(), BookingBuckets, EnrichedBooking, CompanyDocument (+20 more)
...
Cohesion: 0.12
Nodes (24): ExamState, TakeExamDialog(), TakeExamDialogProps, ExternalUsersTable(), ExternalUsersTableProps, UserProfile, InstructorsTable(), InstructorsTableProps (+16 more)
...
Cohesion: 0.06
Nodes (52): DepartmentActionsProps, Department, defaultFindingLevels, FeatureSettings, FindingLevel, FindingLevelsSettings, DebriefRoomBookingFormProps, AlertCard() (+44 more)
...
Cohesion: 0.06
Nodes (42): BillingTable(), BillingTableProps, parseLocalDate(), ActivityLogResponse, ActivityLogRow, ActivityTrackerPage(), describeChange(), formatLogTime() (+34 more)
...
Cohesion: 0.08
Nodes (27): AeronauticalMap, RoutePlannerMapLibreShell, reportCards, QrTarget, FocusCard, ColorThemeFormProps, PalettePreset, ExerciseReviewPageProps (+19 more)
...
Cohesion: 0.12
Nodes (16): GenerateExamOutput, LogbookColumnSchema, parseLogbook(), parseLogbookFlow, ParseLogbookInput, ParseLogbookInputSchema, ParseLogbookOutput, ParseLogbookOutputSchema (+8 more)
...
Cohesion: 0.21
Nodes (15): formatMonitoringDate(), getMonitoringState(), getReportTitle(), getStateClassName(), matchesFilter(), MonitoringFilter, MonitoringRow(), MonitoringState (+7 more)
...
Cohesion: 0.04
Nodes (79): AccountingPage(), AccountingPage(), DepartmentActions(), DepartmentForm(), ExamTopicsPage(), ExternalOrganizationsPage(), NewRolePage(), RoleActions() (+71 more)
...
- **Should `Community 2` be split into smaller, more focused modules?**
  _Cohesion score 0.08866057838660578 - nodes in this community are weakly interconnected._